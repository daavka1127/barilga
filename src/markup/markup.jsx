      ...
      <>
        <BrowserRouter basename={"/"}>
          <Switch>
            ...
            <Route
              path="/projects-masonry-grid-2"
              component={ProjectsMasonryGrid2}
            />
            <Route
              path="/projects-masonry-grid-3"
              component={ProjectsMasonryGrid3}
            />
            <Route
              path="/projects-masonry-grid-4"
              component={ProjectsMasonryGrid4}
            />
            <Route
              path="/projects-masonry-grid-wide"
              component={ProjectsMasonryGridWide}
            />
            ...
            <Route
              path="/solution-agricultural-engineering"
              component={SolutionAgriculturalEngineering}
            />
            <Route
              path="/solution-chemical-research-engineering"
              component={SolutionChemicalResearchEngineering}
            />
            <Route
              path="/solution-material-science-and-engineering"
              component={SolutionMaterialScienceAndEngineering}
            />
            <Route
              path="/solution-mechanical-engineering"
              component={SolutionMechanicalEngineering}
            />
            <Route path="/solution-oil-and-gas" component={SolutionOilAndGas} />
            <Route
              path="/solution-power-and-energy"
              component={SolutionPowerAndEnergy}
            />
