									...
									<ul className="nav navbar-nav">	
										...
										<li className="has-mega-menu "><Link to="#">Бидний тухай<i className="fa fa-chevron-down"></i></Link>
											<ul className="mega-menu">
												<li><Link to="#">Цэс1</Link>
													<ul>
														<li><Link to="about-1"><span>Мэндчилгээ</span></Link></li>
														<li><Link to="about-2"><span>Компанийн танилцуулга</span></Link></li>
														<li><Link to="about-3"><span>Эрхэм зорилго</span></Link></li>
														<li><Link to="awards"><span>Харилцагч байгууллага</span></Link></li>
														<li><Link to="job-career"><span>Удирдлага</span></Link></li>
													</ul>
												</li>
												<li><Link to="#">Цэс2</Link>
													<ul>
														<li><Link to="about-1"><span>Мэндчилгээ</span></Link></li>
														<li><Link to="about-2"><span>Компанийн танилцуулга</span></Link></li>
														<li><Link to="about-3"><span>Эрхэм зорилго</span></Link></li>
										...
										<li><Link to="#">Бүтээн байгуулалт<i className="fa fa-chevron-down"></i></Link>
											<ul className="sub-menu">
												<li className="add-menu-left">
													<ul>
														<li><Link to="solution-agricultural-engineering"><span>Хэрэгжүүлсэн ажлууд</span> </Link></li>
														<li><Link to="solution-chemical-research-engineering"><span>Хэрэгжиж буй ажлууд</span></Link></li>
													</ul>
												</li>
											</ul>
										</li>
