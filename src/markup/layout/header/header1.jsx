              ...
              <div className="row d-flex justify-content-between">
                <div className="topbar-left">
                  <ul>
                    <li>
                      <Link to="#">
                        <i className="la la-phone"></i>Call Us (+00) 286 8591
                      </Link>
                    </li>
                    <li>
                      <Link to="#">
                        <i className="la la-clock"></i>Mon to Fri - 9:00am -
                        6:00pm
                      </Link>
                    </li>
                    <li>
              ...
              <div className="container clearfix">
                      ...
                      <li>
                        ...
                        <ul className="dropdown-menu cart-dropdown cart-list">
                          ...
                          <li className="cart-item subtotal">
                            <h6 className="title m-a0">
                              Subtotal <span>$47.00</span>
                            </h6>
                          </li>
                          <li className="d-flex">
                            <button className="btn button-md flex-fill m-r5">
                              View Cart
                            </button>
                            <button className="btn-secondry button-md flex-fill m-l5">
                              Checkout
                            </button>
                          </li>
                        </ul>
                ...
                >
                  ...
                  <ul className="nav navbar-nav">
                      ...
                      <ul className="mega-menu">
                        <li>
                          ...
                          <ul>
                            <li>
                              <Link to="about-1">
                                <span>About Us Simple</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="about-2">
                                <span>About Us Classic</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="about-3">
                                <span>About Us Modern</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="awards">
                        ...
                        <li>
                          ...
                          <ul>
                            ...
                            <li>
                              <Link to="services-2">
                                <span>Services Classic</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="services-3">
                                <span>Services Modern</span>
                              </Link>
                            </li>
                            <li>
                    ...
                    <li>
                      <Link to="#">
                        Solution<i className="fa fa-chevron-down"></i>
                      </Link>
                      <ul className="sub-menu">
                          ...
                          <ul>
                            ...
                            <li>
                              <Link to="solution-chemical-research-engineering">
                                <span>Chemical Research Engineering</span>
                              </Link>
                            </li>
                            <li>
                            ...
                            <li>
                              <Link to="solution-mechanical-engineering">
                                <span>Mechanical Engineering</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="solution-oil-and-gas">
                                <span>Oil and Gas</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="solution-power-and-energy">
                    ...
                    <li className="has-mega-menu ">
                      ...
                      <ul className="mega-menu">
                        <li>
                          ...
                          <ul>
                            <li>
                              <Link to="projects-grid-2">
                                <span>Projects Grid 2</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="projects-grid-3">
                                <span>Projects Grid 3</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="projects-grid-4">
                                <span>Projects Grid 4</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="projects-grid-wide">
                                <span>Projects Grid Wide</span>
                              </Link>
                            </li>
                          </ul>
                        </li>
                        <li>
                          <Link to="#">Projects Masonry</Link>
                          <ul>
                            <li>
                              <Link to="projects-masonry-grid-2">
                                <span>Masonry Grid 2</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="projects-masonry-grid-3">
                                <span>Masonry Grid 3</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="projects-masonry-grid-4">
                                <span>Masonry Grid 4</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="projects-masonry-grid-wide">
                                <span>Masonry Grid Wide</span>
                              </Link>
                            </li>
                          </ul>
                        </li>
                        <li>
                          ...
                          <ul>
                            <li>
                              <Link to="projects-carousel-1">
                                <span>Projects Carousel 1</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="projects-carousel-2">
                                <span>Projects Carousel 2</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="projects-carousel-3">
                                <span>Projects Carousel 3</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="projects-carousel-4">
                                <span>Projects Carousel 4</span>
                              </Link>
                            </li>
                          </ul>
                        </li>
                        <li>
                          <Link to="#">Projects Single</Link>
                          <ul>
                            <li>
                              <Link to="projects-single-1">
                                <span>Projects Single 1</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="projects-single-2">
                                <span>Projects Single 2</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="projects-single-3">
                                <span>Projects Single 3</span>
                              </Link>
                            </li>
                            <li>
                              <Link to="projects-single-4">
                                <span>Projects Single 4</span>
                              </Link>
                            </li>
                          </ul>
                        </li>
                    ...
                    <li>
                      ...
                      <ul className="sub-menu left">
                        ...
                        <li>
                          <Link to="blog-classic-sidebar">
                            <span>Blog Classic Sidebar</span>
                          </Link>
                        </li>
                        <li>
                          <Link to="blog-list">
                        ...
                        <li>
                          <Link to="blog-masonry">
                            <span>Masonry</span>
                          </Link>
                        </li>
                        <li>
                          <Link to="blog-details-sidebar">
